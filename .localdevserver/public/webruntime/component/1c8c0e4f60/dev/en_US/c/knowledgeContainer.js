Webruntime.moduleRegistry.define('c/knowledgeContainer', ['lwc', 'lightning/configProvider', 'force/lds', 'wire-service'], function (lwc, configProvider, lds, wireService) { 'use strict';
    ...
    **/
    ...
    if (_implicitStylesheets$4) {
      tmpl$g.stylesheets.push.apply(tmpl$g.stylesheets, _implicitStylesheets$4);
    }
    ...
    */
    ...
    if (_implicitStylesheets) {
      tmpl$j.stylesheets.push.apply(tmpl$j.stylesheets, _implicitStylesheets);
    }
    ...
    function tmpl$m($api, $cmp, $slotset, $ctx) {
      ...
      return api_flatten([api_custom_element("lightning-input", _lightningInput, {
        ...
        return api_element("div", {
          ...
          key: 7
        }, []), api_dynamic(article.Title)]), api_dynamic(article.Summary), api_element("div", {
          attrs: {
            "slot": "footer"
          },
          key: 8
