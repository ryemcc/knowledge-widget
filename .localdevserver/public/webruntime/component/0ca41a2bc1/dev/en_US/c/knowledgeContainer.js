Webruntime.moduleRegistry.define('c/knowledgeContainer', ['lwc', 'lightning/configProvider', 'force/lds', 'wire-service'], function (lwc, configProvider, lds, wireService) { 'use strict';

  function stylesheet(hostSelector, shadowSelector, nativeShadow) {
    return ".card-container" + shadowSelector + " {cursor: pointer;margin-bottom: 0.5rem;max-width: 40rem;}\n.summary" + shadowSelector + " {overflow: hidden;text-overflow: ellipsis;display: -webkit-box;-webkit-line-clamp: 3;-webkit-box-orient: vertical;}\n";
  }
  ...
  * */
  ...
  tmpl$k.slots = ["title", "actions", "", "footer"];
  tmpl$k.stylesheets = [];
  ...
  function tmpl$m($api, $cmp, $slotset, $ctx) {
    ...
    return api_flatten([api_custom_element("lightning-input", _lightningInput, {
      props: {
        "type": "search",
        "isLoading": $cmp.searchInFlight,
    ...
    }, []), api_iterator($cmp.articles, function (article) {
      return api_element("div", {
        classMap: {
          "card-container": true
        },
        ...
        key: api_key(4, article.Id),
        on: {
          "click": _m1 || ($ctx._m1 = api_bind($cmp.handleArticleClick))
        }
        ...
        key: 7
      }, []), api_dynamic(article.Title)]), api_element("div", {
        classMap: {
          "summary": true
        },
        key: 8
      }, [api_dynamic(article.Summary)]), api_element("div", {
        attrs: {
          "slot": "footer"
        },
        key: 9
  ...
  tmpl$m.stylesheetTokens = {
    hostAttribute: "lwc-knowledgeContainer_knowledgeContainer-host",
    shadowAttribute: "lwc-knowledgeContainer_knowledgeContainer"
  };

  const apexInvoker = lds.getApexInvoker("", "KnowledgeController", "searchKnowledge", false);
  wireService.register(apexInvoker, lds.generateGetApexWireAdapter("", "KnowledgeController", "searchKnowledge", false));

  class KnowledgeContainer extends lwc.LightningElement {
    constructor(...args) {
      super(...args);
    ...
    async handleKeyUp(e) {
      ...
      this.timeoutId = setTimeout(async () => {
        ...
        const response = await apexInvoker({
          query
        });
  ...
  lwc.registerDecorators(KnowledgeContainer, {
    track: {
      searchInFlight: 1,
      articles: 1
    }
  ...
  var knowledgeContainer = lwc.registerComponent(KnowledgeContainer, {
    tmpl: _tmpl$l
  });
